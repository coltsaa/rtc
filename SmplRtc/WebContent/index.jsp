...
<script type="text/javascript">
	var socket =new WebSocket("wss://172.25.156.40:8443/SmplRtc/gashat");
...
<body>
	...
	<a id="create" href="/SmplRtc/#true" onclick="init()">点击此链接新建聊天室</a><br>
	<p id="tips" style="background-color:red">请在其他浏览器中打开：https://ip:8443/SmplRtc   加入此视频聊天</p>
</body>
</html>
